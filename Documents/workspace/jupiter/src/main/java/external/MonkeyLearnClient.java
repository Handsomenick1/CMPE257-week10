...
public class MonkeyLearnClient {
	private static final String API_KEY = "ee1ddff6bb8e96da7a92eea1eb09901d8a94d824";// make sure change it to your api key.
	...
	public static List<List<String>> extractKeywords(String[] text) {
		...
		ExtraParam[] extraParams = { new ExtraParam("max_keywords", "3") }; // '3' is number of keywords
		MonkeyLearnResponse response;
		try {
			response = ml.extractors.extract(MODEL, text, extraParams);//change to your model id
 ...
 * 	[Google, brian, machine learning].
 * ]
 * 
 * convert to List of List of String
 * <
 * 	<Elon... >
 * 	<facebook ..>
 *  <..>
